import { IterableDifferFactory } from './differs/iterable_differs';
import { KeyValueDifferFactory } from './differs/keyvalue_differs';
...
export declare const defaultIterableDiffers: any;
export declare const defaultKeyValueDiffers: any;
